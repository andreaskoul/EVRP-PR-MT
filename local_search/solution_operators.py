...
def do_3optstar_move(solution, D, d,
    ...
    if isinstance(solution, list):
        sol_cum_d_fwd, sol_cum_l_fwd = \
            _build_cumulative_lists(solution, D, d, +1)
    ...
    if best_move:
        ...
        if return_solution_with_auxiliary_data:
            raise NotImplementedError(
                "Changing and returning the modified aux data is not implemented, please recalculate it instead.")
        else:
